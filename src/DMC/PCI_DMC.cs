...
namespace PCI_DMC
{
    public class CPCI_DMC
    {
        ...
        public static extern short CS_DMC_01_get_devicetype(ushort CardNo, ushort NodeID, ushort SlotID, ref uint DeviceType, ref uint IdentityObject);
        ...
        public static extern short CS_DMC_01_send_message3(ushort CardNo, ref ushort Index, ref ushort SubIdx, ref ushort DataType, ref ushort Value0, ref ushort Value1, ref ushort Value2, ref ushort Value3);
        ...
        public static extern short CS_DMC_01_read_message(ushort CardNo, ref ushort Cmd, ref ushort COBID, ref ushort SubIdx, ref ushort Value0, ref ushort Value1, ref ushort Value2, ref ushort Value3);
        [DllImport("PCI_DMC.dll", EntryPoint = "_DMC_01_read_message2")]
        public static extern short CS_DMC_01_read_message2(ushort CardNo, ushort NodeID, ref ushort Cmd, ref ushort COBID, ref ushort SubIdx, ref ushort Value0, ref ushort Value1, ref ushort Value2, ref ushort Value3, ref ushort cnt);
        [DllImport("PCI_DMC.dll", EntryPoint = "_DMC_01_get_message")]
        public static extern short CS_DMC_01_get_message(ushort CardNo, ushort NodeID, ushort SlotID, ushort Index, ushort SubIdx, ref ushort Cmd, ref ushort COBID, ref ushort SubIndex, ref ushort Value0, ref ushort Value1, ref ushort Value2, ref ushort Value3);
        ...
        public static extern short CS_DMC_01_start_sdo_driver_a_move(ushort CardNo, ushort NodeID, ushort SlotID, int Position);
        [DllImport("PCI_DMC.dll", EntryPoint = "_DMC_01_start_sdo_driver_new_position_move")]
        public static extern short CS_DMC_01_start_sdo_driver_new_position_move(ushort CardNo, ushort NodeID, ushort SlotID, int Position, ushort abs_rel);
        ...
        public static extern short CS_DMC_01_buf_dwell(ushort CardNo, ushort NodeID, ushort SlotID, int dwell_cnt);
        [DllImport("PCI_DMC.dll", EntryPoint = "_DMC_01_sync_move")]
        public static extern short CS_DMC_01_sync_move(ushort CardNo);
        [DllImport("PCI_DMC.dll", EntryPoint = "_DMC_01_sync_move_config")]
        public static extern short CS_DMC_01_sync_move_config(ushort CardNo, ushort NodeID, ushort SlotID, short enable);
        ...
        public static extern short CS_DMC_01_get_slave_version(ushort CardNo, ushort NodeID, ushort SlotID, ref ushort version);
        ...
        public static extern short CS_DMC_01_set_trigger_buf_function(ushort CardNo, ushort NodeID, ushort SlotID, ushort enable);
        ...
        public static extern short CS_DMC_01_get_DLL_path_Single(ushort CardNo, string lpFilePath, uint nSize, ref uint nLength);
        [DllImport("PCI_DMC.dll", EntryPoint = "_DMC_01_get_DLL_version_Single")]
        public static extern short CS_DMC_01_get_DLL_version_Single(ushort CardNo, string lpBuf, uint nSize, ref uint nLength);
        ...
        public static extern short CS_DMC_01_set_cam_org(ushort CardNo, ushort NodeID, ushort SlotID, short Dir, int orgpos);
        [DllImport("PCI_DMC.dll", EntryPoint = "_DMC_01_set_cam_enable")]
        public static extern short CS_DMC_01_set_cam_enable(ushort CardNo, ushort NodeID, ushort SlotID, ushort on_off);
        [DllImport("PCI_DMC.dll", EntryPoint = "_DMC_01_set_cam_mode")]
        public static extern short CS_DMC_01_set_cam_mode(ushort CardNo, ushort NodeID, ushort SlotID, ushort Mode);
        [DllImport("PCI_DMC.dll", EntryPoint = "_DMC_01_set_cam_table")]
        public static extern short CS_DMC_01_set_cam_table(ushort CardNo, ushort NodeID, ushort SlotID, short Dir, ref int table);
        [DllImport("PCI_DMC.dll", EntryPoint = "_DMC_01_set_cam_table2")]
        public static extern short CS_DMC_01_set_cam_table2(ushort CardNo, ushort NodeID, ushort SlotID, short Dir, ref int table, int Num);
        [DllImport("PCI_DMC.dll", EntryPoint = "_DMC_01_set_dmc_mode")]
        public static extern short CS_DMC_01_set_dmc_mode(ushort CardNo, ushort NodeID, ushort SlotID);
        [DllImport("PCI_DMC.dll", EntryPoint = "_DMC_01_set_backlash")]
        public static extern short CS_DMC_01_set_backlash(ushort CardNo, ushort NodeID, ushort SlotID, short enable);
        [DllImport("PCI_DMC.dll", EntryPoint = "_DMC_01_set_backlash_info")]
        public static extern short CS_DMC_01_set_backlash_info(ushort CardNo, ushort NodeID, ushort SlotID, short backlash, ushort accstep, ushort contstep, ushort decstep);
        [DllImport("PCI_DMC.dll", EntryPoint = "_DMC_01_enable_electcam")]
        public static extern short CS_DMC_01_enable_electcam(ushort CardNo, ushort NodeID, ushort SlotID, ushort enable, ushort axisbit, ushort mode);
        [DllImport("PCI_DMC.dll", EntryPoint = "_DMC_01_set_cv_mode")]
        public static extern short CS_DMC_01_set_cv_mode(ushort CardNo, ushort NodeID, ushort SlotID, ushort flag_const_v, ushort flag_dec_c);
        [DllImport("PCI_DMC.dll", EntryPoint = "_DMC_01_enable_ex_position")]
        public static extern short CS_DMC_01_enable_ex_position(ushort CardNo, ushort NodeID, ushort SlotID, ushort enable);
        ...
        public static extern short CS_DMC_01_get_nrline_status(ushort CardNo, ushort NodeID, ushort SlotID, ref ushort nrline_sts);
        ...
        public static extern short CS_DMC_01_set_position_ref_source(ushort CardNo, ushort NodeID, ushort SlotID, short ref_source);
        [DllImport("PCI_DMC.dll", EntryPoint = "_DMC_01_get_position_ref_source")]
        public static extern short CS_DMC_01_get_position_ref_source(ushort CardNo, ushort NodeID, ushort SlotID, ref short ref_source);
        [DllImport("PCI_DMC.dll", EntryPoint = "_DMC_01_set_virtual_command")]
        public static extern short CS_DMC_01_set_virtual_command(ushort CardNo, ushort NodeID, ushort SlotID, int virtual_command);
        [DllImport("PCI_DMC.dll", EntryPoint = "_DMC_01_get_virtual_command")]
        public static extern short CS_DMC_01_get_virtual_command(ushort CardNo, ushort NodeID, ushort SlotID, ref int virtual_command);

        //2013.11.07
        [DllImport("PCI_DMC.dll", EntryPoint = "_DMC_01_set_virtual_position")]
        public static extern short CS_DMC_01_set_virtual_position(ushort CardNo, ushort NodeID, ushort SlotID, int virtual_Position);
        [DllImport("PCI_DMC.dll", EntryPoint = "_DMC_01_disable_virtual_pos")]
        public static extern short CS_DMC_01_disable_virtual_pos(ushort CardNo, ushort NodeID, ushort SlotID, ushort on_off);
        [DllImport("PCI_DMC.dll", EntryPoint = "_DMC_01_Set_Stepping_Move_rate")]
        public static extern short CS_DMC_01_Set_Stepping_Move_rate(ushort CardNo, ushort NodeID, ushort SlotID, byte MoveRatio);
        ...
        public static extern short CS_DMC_01_Get_Stepping_Move_rate(ushort CardNo, ushort NodeID, ushort SlotID, ref byte MoveRatio);
        ...
        public static extern short CS_DMC_01_set_feedrate_overwrite_rate(ushort CardNo, ushort NodeID, ushort SlotID, double feedrate);

        //2013.12.31
        [DllImport("PCI_DMC.dll", EntryPoint = "_DMC_01_start_v3_ellipse_xy")]
        public static extern short CS_DMC_01_start_v3_ellipse_xy(ushort CardNo, ref ushort NodeID, ref ushort SlotID, int Center_X, int Center_Y, int majorRadius, int minorRadius, double Angle, short mode, int StrVel, int ConstVel, int EndVel, double Tphase1, double Tphase2, ushort m_curve, ushort m_r_a);
